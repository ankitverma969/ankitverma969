...
<table border="0" width="100%">
  <tr>
    <td width="60%">
      ...
      <br><br>
      - 🚀 <b>Currently</b> building scalable AI systems & Agentic workflows.<br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li>Agentic AI workflow using <b>LangChain</b> and <b>LangGraph</b> for context-aware responses.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><b>Data Science Certification</b><br>From Data to Decisions: A Hands-On Approach to Data Science (LPU Training Program).</li>
      </ul>
    </td>
  </tr>
</table>
